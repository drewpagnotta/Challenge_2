...
# Given that I’m using the loan qualifier CLI, when I choose to save the loans, then the tool should save the results as a CSV file.
    ...
    if len(qualifying_loans) > 0:
        ...
        if save == "Yes":
            ...
            # If the user declines to save their list of loans, they can review the list without saving.
            if save == "No":
                print("That's okay! Please review your list of loans at this time.")
            
            # The user answers Yes to save, and the CSV file generates with the list of headers and appropriate data.
            if save == "Yes":
